...
function createAccount() {
    ...
    if (validName && validEmail && validPassword) {
        // All is good, successful create account
...
function checkName() {
    // Ensure the user has entered a name with only letters
    var nameEntered = document.getElementById("fullname").value;

    // Remove whitespace from name entered
...
function checkPasswords() {
    // Check if both password fields have been filled out and that they match.
